...
var file_authservice_proto_rawDesc = []byte{
	...
	0x32, 0x46, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
...
var file_authservice_proto_depIdxs = []int32{
	0, // 0: proto.v1.AuthService.Ping:input_type -> proto.v1.PingRequest
	1, // 1: proto.v1.AuthService.Ping:output_type -> proto.v1.PongResponse
